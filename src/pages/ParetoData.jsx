...
function Pareto() {
  ...
  const fetchData = async () => {
    let response1 = await axios.get("http://10.126.15.137:8002/part/line1", {
      params: {
        date: date,
      },
    });
    ...
    let response2 = await axios.get("http://10.126.15.137:8002/part/line2", {
      params: {
        date: date,
      },
    });
    ...
    let response3 = await axios.get("http://10.126.15.137:8002/part/line3", {
      params: {
        date: date,
      },
    });
  ...
  // ini yg dibawah chart ke-2 dari breakdown pareto
  return (
    <div class="p-6">
      <ParetoChart
        width={3}
