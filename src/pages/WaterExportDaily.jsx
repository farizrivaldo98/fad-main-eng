...
function WaterExportDaily() {
    ...
    const fetchWaterConsumption = async () => {
        let response = await axios.get(
            "http://10.126.15.137:8002/part/ExportWaterConsumptionDaily", 
            {
              params: {
                start: startDate,
                finish: finishDate,
    ...
    const fetchWaterTotalizer = async () => {
        let response1 = await axios.get(
            "http://10.126.15.137:8002/part/ExportWaterTotalizerDaily",
            {
              params: {
                start: startDate,
                finish: finishDate,
    ...
    return (
        <div>
            <div align="center"><h1 className="text-4xl"><b>Export Daily Water Data </b></h1></div>
            <br />
            <Stack
